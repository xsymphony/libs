...
func NewSetUint64(elements ...uint64) *SetUint64 {
	set := &SetUint64{
...
func (set *SetUint64) has(elem uint64) bool {
	_, exist := set.values[elem]
	return exist
}

func (set *SetUint64) add(elem uint64) {
	if set.values == nil {
		set.values = make(map[uint64]struct{})
	}
	set.values[elem] = struct{}{}
}

func (set *SetUint64) Add(elem uint64) bool {
	if set.has(elem) {
		return true
	}
	set.add(elem)
...
func (set *SetUint64) Update(elements ...uint64) {
	for _, element := range elements {
		set.add(element)
	}
}

func (set *SetUint64) Remove(elem uint64) bool {
	if !set.has(elem) {
		return false
	}
	delete(set.values, elem)
...
// 遍历集合
func (set *SetUint64) Range(f func(element uint64)) {
	for value := range set.values {
		f(value)
	}
}
...
// copy一个新的集合
func (set *SetUint64) Copy() *SetUint64 {
	copyed := NewSetUint64()
	set.Range(func(element uint64) {
		copyed.Add(element)
	})
	return copyed
}
...
// 求并集
func (set *SetUint64) Union(another *SetUint64) *SetUint64 {
	union := set.Copy()
	another.Range(func(element uint64) {
		union.Add(element)
	})
	return union
}
...
// 求交集
func (set *SetUint64) Intersect(another *SetUint64) *SetUint64 {
	intersect := NewSetUint64()
	set.Range(func(element uint64) {
		if another.Has(element) {
			intersect.Add(element)
		}
...
// 求差集
func (set *SetUint64) Except(another *SetUint64) *SetUint64 {
	except := NewSetUint64()
	set.Range(func(element uint64) {
		if !another.Has(element) {
			except.Add(element)
...
// 集合长度
func (set *SetUint64) Length() int {
	return len(set.values)
}

// 集合转化为slice结构
func (set *SetUint64) Uint64List() []uint64 {
	lst := make([]uint64, 0, set.Length())
	set.Range(func(element uint64) {
		lst = append(lst, element)
	})
...
func NewSetUint32(elements ...uint32) *SetUint32 {
	set := &SetUint32{
...
func (set *SetUint32) has(elem uint32) bool {
	_, exist := set.values[elem]
	return exist
}

func (set *SetUint32) add(elem uint32) {
	if set.values == nil {
		set.values = make(map[uint32]struct{})
	}
	set.values[elem] = struct{}{}
}

func (set *SetUint32) Add(elem uint32) bool {
	if set.has(elem) {
		return true
	}
	set.add(elem)
...
func (set *SetUint32) Update(elements ...uint32) {
	for _, element := range elements {
		set.add(element)
	}
}

func (set *SetUint32) Remove(elem uint32) bool {
	if !set.has(elem) {
		return false
	}
	delete(set.values, elem)
...
// 遍历集合
func (set *SetUint32) Range(f func(element uint32)) {
	for value := range set.values {
		f(value)
	}
}
...
// copy一个新的集合
func (set *SetUint32) Copy() *SetUint32 {
	copyed := NewSetUint32()
	set.Range(func(element uint32) {
		copyed.Add(element)
	})
	return copyed
}
...
// 求并集
func (set *SetUint32) Union(another *SetUint32) *SetUint32 {
	union := set.Copy()
	another.Range(func(element uint32) {
		union.Add(element)
	})
	return union
}
...
// 求交集
func (set *SetUint32) Intersect(another *SetUint32) *SetUint32 {
	intersect := NewSetUint32()
	set.Range(func(element uint32) {
		if another.Has(element) {
			intersect.Add(element)
		}
...
// 求差集
func (set *SetUint32) Except(another *SetUint32) *SetUint32 {
	except := NewSetUint32()
	set.Range(func(element uint32) {
		if !another.Has(element) {
			except.Add(element)
...
// 集合长度
func (set *SetUint32) Length() int {
	return len(set.values)
}

// 集合转化为slice结构
func (set *SetUint32) Uint32List() []uint32 {
	lst := make([]uint32, 0, set.Length())
	set.Range(func(element uint32) {
		lst = append(lst, element)
	})
